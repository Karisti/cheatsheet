...
![arquitectura_de_docker](https://github.com/Karisti/cheatsheet/blob/master/docker/img/arquitectura_de_docker.png)

In a way, Docker is a bit like a virtual machine. But unlike a virtual machine, rather than creating a whole virtual operating system, Docker allows applications to use the same Linux kernel as the system that they're running on and only requires applications be shipped with things not already running on the host computer. This gives a significant performance boost and reduces the size of the application.

![containers-vs-virtual-machines](https://github.com/Karisti/cheatsheet/blob/master/docker/img/containers-vs-virtual-machines.jpg)
